...
VolumeRenderer::VolumeRenderer(VolumeBuffer *volume) :m_volume(volume), m_vbo(0), m_ibo(0)
{
	LoadPrograms();
...
void VolumeRenderer::Render(const glm::mat4 &proj, const glm::mat4 &modelview) {
...
void VolumeRenderer::DrawSimple(const glm::mat4 &proj, const glm::mat4 &modelview) {
...
void VolumeRenderer::DrawWireframe(const glm::mat4 &proj, const glm::mat4 &modelview) {
...
void VolumeRenderer::DrawCube(bool hasTex) {
...
void VolumeRenderer::SetVolume(VolumeBuffer *volume) {
	m_volume = volume;
}

void VolumeRenderer::SetDensity(float x) {
	m_density = x;
}

void VolumeRenderer::SetBrightness(float x) {
	m_brightness = x;
}
